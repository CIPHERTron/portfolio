...
const Layout = ({ children, pathname, pageTitle, pageDescription }: ILayout) => {
  ...
  return (
    <MenuContext.Provider value={{ menuOpen, toggleMenuOpen }}>
      <Head>
        ...
        <meta property='og:image' content={SiteConfig.site.siteImage} key='ogimage' />
        <meta property='og:site_name' content={SiteConfig.site.siteName} key='ogsitename' />

        {/* Twitter Cards */}
        <meta name='twitter:card' content='summary' key='twcard' />
        <meta name='twitter:creator' content={SiteConfig.author.twitterHandle} key='twhandle' />
